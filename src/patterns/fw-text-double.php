...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:25%"><!-- wp:image {"id":420,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="https://images.utk.edu/wds/1x1-placeholder.png" alt="1x1 placeholder" class="wp-image-420"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
