...
// Get the stylesheet
 function mychildtheme_enqueue_styles() {
	wp_enqueue_style( 'utkchancellor-fontstyle', "https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,200;0,700;0,800;0,900;1,200;1,400;1,700;1,800;1,900&display=swap" );
